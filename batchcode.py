...
output_filename = 'data/federal-coordinates.csv'
# Set your input file here
input_filename = "input-data/house-of-commons.csv"
...
def get_google_results(address, api_key=None, return_full_response=False):
    ...
    if len(results['results']) == 0:
        ...
        output = {
            ...
            "coordinates": f"{answer.get('geometry').get('location').get('lat')},{answer.get('geometry').get('location').get('lng')}",
...
pd.DataFrame(results).to_csv(output_filename, encoding='cp1252')
# change back to utf-8 if cp does not work